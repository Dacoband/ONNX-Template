...
using OnnxRuntime.Final.ConcatenateTensors.utils;

namespace OnnxRuntime.Final.ConcatenateTensors
{
  class Program
    {
        public static void Main(string[] args)
        {
            string modelFilePath = @"D:\OJT_SU24\ONNX-Template\OnnxRuntime.Final.ConcatenateTensors\OnnxRuntime.Final.ConcatenateTensors\OnnxRuntime.Final.ConcatenateTensors\model\test_wb.onnx";
            var imageFilePath = new List<string>
            {
                @"D:\OJT_SU24\ONNX-Template\OnnxRuntime.Final.ConcatenateTensors\OnnxRuntime.Final.ConcatenateTensors\OnnxRuntime.Final.ConcatenateTensors\data\8D5U5524_D.png",
                @"D:\OJT_SU24\ONNX-Template\OnnxRuntime.Final.ConcatenateTensors\OnnxRuntime.Final.ConcatenateTensors\OnnxRuntime.Final.ConcatenateTensors\data\8D5U5524_S.png",
                @"D:\OJT_SU24\ONNX-Template\OnnxRuntime.Final.ConcatenateTensors\OnnxRuntime.Final.ConcatenateTensors\OnnxRuntime.Final.ConcatenateTensors\data\8D5U5524_T.png"
            };
